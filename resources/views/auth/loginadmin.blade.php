...
<body class="bg-white">
    ...
    <div id="appCapsule" class="pt-0">
        ...
        <div class="login-form mt-1">
            <div class="section">
                <img src="{{asset('assets/img/sample/photo/vector4.png')}}" alt="image" class="form-image" style="margin-top: 40px">
            </div>
            <div class="section mt-1">
                <h1>Admin Pemilihan OSIS</h1>
                ...
                <form action="/prosesloginadmin" method="POST">
                    ...
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <input type="nisn" class="form-control" id="email" name="email" placeholder="Email">
                            <i class="clear-input">
                    ...
                    <div class="form-button-group">
                        <button type="submit" class="btn btn-primary btn-block btn-lg" style="position: relative">Log in</button>
                    </div>
